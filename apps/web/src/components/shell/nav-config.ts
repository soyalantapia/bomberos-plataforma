...
const NAV_FINANZAS: NavItem[] = [
  ...
  {
    label: 'Conciliación',
    href: '/mando/finanzas/conciliacion',
    icon: 'scale',
    nuevo: true,
    seccion: 'Día a día',
  },
...
const NAV_FEDERACION: NavItem[] = [
  // 100% finanzas: la economía de la red para el presidente de la Federación.
  { label: 'Reloj', href: '/federacion', icon: 'calendar-clock', bottomNav: true },
  {
    label: 'Por ejecutar',
    href: '/federacion/subsidios',
    icon: 'badge-dollar-sign',
    bottomNav: true,
    bottomLabel: 'Ejecutar',
  },
  {
    label: 'Proyección',
    href: '/federacion/proyeccion',
    icon: 'trending-up',
    bottomNav: true,
    bottomLabel: 'Proyec.',
  },
  {
    ...
    href: '/federacion/salud',
    icon: 'heart-pulse',
    bottomNav: true,
    bottomLabel: 'Salud',
    nuevo: true,
  },
  { label: 'Avisos', href: '/federacion/comunicados', icon: 'megaphone', bottomNav: true },
  DIRECTORIO_PUBLICO,
  AGENDA_PUBLICA,
  ORGANIGRAMA_PUBLICO,
];
