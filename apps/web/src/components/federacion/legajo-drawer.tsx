...
export function LegajoDrawer({ persona, cuartel, onClose }: Props) {
      ...
      {persona && (
        <>
          ...
          <motion.aside
            ...
            className="fixed bottom-0 right-0 top-0 z-50 flex w-full max-w-3xl flex-col bg-slate-50 shadow-2xl"
            role="dialog"
            aria-modal="true"
          >
            {/* Header rojo estilo legajo institucional */}
            <header className="bg-fire-700 shrink-0 px-5 py-4 text-white">
