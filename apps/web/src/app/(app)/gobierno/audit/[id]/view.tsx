...
export default function FichaAuditView() {
  ...
  async function generarHash() {
    ...
    toast.push({
      ...
      description: 'Verificado contra el evento original',
    });
  }
  ...
  function copiar(texto: string) {
    ...
    toast.push({
      ...
      description: 'Pegá donde necesites',
    });
  }
    ...
    <div className="mx-auto max-w-5xl space-y-5">
      ...
      <PageHero
        ...
        meta={
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <Kpi
              label="Perfil de quien actuó"
              value={perfilLabel[evento.actorPerfil]}
              intent="neutral"
            />
            <Kpi label="Verificación" value="Comprobante único" intent="ok" />
            <Kpi label="Estado" value="Íntegro" intent="ok" />
          </div>
        }
        acciones={
        ...
        <Card className="lg:col-span-2">
          <CardContent className="p-5">
            ...
            <dl className="space-y-2 text-sm">
              ...
              <div className="grid grid-cols-[140px_1fr] gap-2">
                <dt className="text-slate-500">Quien actuó</dt>
                <dd>
                  <Link
            ...
            <CardContent className="p-4">
              ...
              {hashGenerado ? (
                ...
                <Button intent="primary" fullWidth size="sm" onClick={generarHash}>
                  <Hash size={12} /> Generar comprobante
                </Button>
              )}
              <p className="mt-2 text-[11px] text-slate-500">
                Se calcula en tu navegador. Si modificás cualquier campo del evento, el comprobante
                cambia.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-xs font-bold uppercase text-slate-500">Datos de origen</span>
              </div>
              <dl className="space-y-1.5 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-slate-700">Celular · iOS</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-slate-500">Encriptado</dt>
                  <dd className="text-status-ok-fg font-bold">Sí</dd>
                </div>
                <div className="flex justify-between">
      ...
      <Card className="border-slate-200 bg-slate-50">
        <CardContent className="p-4 text-sm text-slate-600">
          ...
          parte del registro que no se puede modificar. El comprobante único garantiza que ningún
          campo fue modificado desde su creación. Verificable por cualquier auditor externo con la
          URL pública.
        </CardContent>
      </Card>
    </div>
