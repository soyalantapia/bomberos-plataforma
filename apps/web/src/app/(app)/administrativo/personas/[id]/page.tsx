...
export default function FichaPersona() {
  ...
  function solicitar(campo: string) {
    toast.push({
      ...
      description: 'La persona recibe notificación. Confirma con OTP y queda en audit log.',
    });
  }
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      ...
      <PageHero
        ...
        descripcion={`${persona.funcion} · ${persona.base}. Toda edición queda en audit log con tu firma.`}
        icono={
          <Avatar
          ...
          <Card>
            <CardContent className="p-5">
              <div className="bg-status-warn-bg text-status-warn-fg mb-4 inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-xs font-semibold">
                <ShieldCheck size={12} /> Acceso sensible · cifrado a nivel campo
              </div>
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <p className="mt-3 text-xs text-slate-500">
                Los herederos figuran en la planilla del Fondo · cambios requieren OTP del titular.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
