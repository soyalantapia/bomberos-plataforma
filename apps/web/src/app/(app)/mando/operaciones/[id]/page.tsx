  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5">
      ...
      <PageHero
        ...
        acciones={
          servicio.estado === 'pendiente_validacion' ? (
            ...
            <Badge intent="ok">
              <ShieldCheck size={10} className="mr-1" /> Firmado en audit log
            </Badge>
          )
        }
      />
          ...
          <Card>
            <CardContent className="space-y-2 p-3">
              ...
              <Link href={`/mando/parte-nfirs?servicio=${servicio.id}` as never}>
                <Button intent="secondary" size="sm" fullWidth>
                  <FileText size={12} /> Generar parte NFIRS-AR
                </Button>
              </Link>
            </CardContent>
          </Card>
      ...
      <ConfirmDialog
        ...
        descripcion="Una vez validado, se suma al cómputo y a la rendición del mes. Acción registrada en audit log con tu firma."
