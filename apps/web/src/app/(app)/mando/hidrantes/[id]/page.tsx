...
export default function FichaHidrantePage() {
  ...
  function ejecutarReclamo() {
    ...
    toast.push({
      ...
      description: 'SLA 72hs hábiles · audit log firmado',
    });
  }
  ...
  function registrarTest() {
    ...
    toast.push({
      ...
      description: `Próximo test programado para ${new Date(hidrante.proximoTest).toLocaleDateString('es-AR')}`,
    });
  }
    ...
    <div className="mx-auto max-w-6xl space-y-5">
        ...
        acciones={
          <>
            <Button intent="primary" onClick={() => setConfirmaTest(true)}>
              <CheckCircle2 size={14} /> Registrar test
            </Button>
        ...
        <CardContent className="p-0">
          <div className="border-b border-slate-100 px-5 py-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-slate-900">Historial de tests</h3>
            </div>
          </div>
      ...
      <Card className="border-slate-200 bg-slate-50">
        <CardContent className="p-4 text-sm text-slate-600">
          <strong className="text-slate-900">NFPA 291:</strong> los hidrantes se testean cada 6
          meses según el código de color (rojo &lt;500 L/m, amarillo 500-1000, azul 1000-1500, verde
          &gt;1500). Variaciones &gt;30% requieren mantenimiento prioritario.
        </CardContent>
      </Card>
      ...
      <ConfirmDialog
        ...
        titulo="¿Registrar test del hidrante?"
        descripcion={`Vas a registrar un test exitoso para ${hidrante.codigo}. El próximo test se programa automáticamente.`}
      ...
      <ConfirmDialog
        ...
        descripcion={`Se notifica a la prestadora con código ${hidrante.codigo}. SLA: 72 horas hábiles.`}
