...
export default function FichaPersonaMandoPage() {
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 text-sm">
                  <strong className="text-brand-900">Ranking del mes:</strong> ocupa el puesto{' '}
                  <strong>#3</strong> en horas operativas del cuartel. Promedio de{' '}
                  {Math.round(horasMes / 4)} hs/semana.
                </div>
              </div>
            </CardContent>
          </Card>
